...
public class Text3 extends HttpServlet {
    ...
    static final String DB_URL = "jdbc:mysql://192.168.220.133/linux_final?useUnicode=true&characterEncoding=utf8&useSSL=false&serverTimezone=GMT%2B8";
   ...
   public void init() {
      try {
         ...
         jedis = new Jedis("192.168.220.133"); 
